...
class GKQuiz extends StatefulWidget {
  const GKQuiz({super.key});

  @override
  State<GKQuiz> createState() => _GKQuizState();
}

class _GKQuizState extends State<GKQuiz> {
  ...
  Widget build(BuildContext context) {
    ...
    void resetQuestions() {
      setState(() {
        for (var question in qItems.gkItems) {
    ...
    Color firstColor = HexColor('#DAE2F8');
    Color secondColor = HexColor('#D6A4A4');
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    final question = qItems.gkItems[index];
                    return Column(
                      children: [
                        SizedBox(
                          height: 70,
