...
class _GuessTheWordState extends State<GuessTheWord> {
  ...
  Widget build(BuildContext context) {
    ...
    void resetQuestions() {
      setState(() {
        for (var question in qItems.guessItems) {
    ...
    Color firstColor = HexColor('#948EB9');
    Color secondColor = HexColor('#2E1437');
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    final question = qItems.guessItems[index];
                    return Column(
                      children: [
                        SizedBox(
                          height: 70,
